...
/*
    ...
    skrypt odpowiedzialny głownie za roznego radzaju kolizje, pochylnie
    ile promieni sprawdzajacych itp
...
public class Controller2D : RaycastController
{
        ...
        for (int i = 0; i < horizontalRayCount; i++)
        {
            ...
            if (hit)                                                                            // skutek zderzenia z podlozem
            {
                ...
                if(i == 0 && slopeAngle <= maxClimbAngle)
                {
                    ...
                    if (slopeAngle != collisions.slopeAngleOld)                                 // jesli zaczyna sie pochylnia
                    {
    ...
    void VerticalCollisions(ref Vector3 velocity)                                               // sprawdzanie kulizji w pionie
    {
    ...
    void DescendSlope(ref Vector3 velocity)
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(rayOrigin.normalized, - Vector2.up, Mathf.Infinity, collisionMask);
